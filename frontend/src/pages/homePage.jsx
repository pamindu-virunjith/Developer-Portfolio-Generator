  ...
  return (
    <div className="w-full h-full bg-gradient-hero text-white">
      ...
      <nav className="w-full flex items-center justify-between p-6">
        ...
        <Link to="/create">
          <button
            className="font-display text-xl border border-[hsl(var(--primary))]/30 text-[hsl(var(--primary))] hover:bg-[hsl(var(--primary))]/10 bg-black py-1 px-2 rounded-sm cursor-pointer"
          >
            Create Portfolio
          </button>
        </Link>
      ...
      {/* Hero */}
      <section className="w-full flex flex-col items-center text-center pt-20 pb-32 gap-6">
        <motion.div
      ...
      {/* Features */}
      <section className="px-20 md:px-40 pb-15">
      ...
      {/* Footer */}
      <footer className="w-full border-t border-[hsl(var(--border))] py-8 text-center">
        <p className="text-[hsl(var(--muted-foreground))] text-xl ">
